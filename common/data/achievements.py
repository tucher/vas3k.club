...
ACHIEVEMENTS = [
    ...
    ("org", {
        ...
        "image": f"{settings.APP_HOST}/static/images/achievements/org.png",
    ...
    ("mic", {
        ...
        "image": f"{settings.APP_HOST}/static/images/achievements/mic.png",
    ...
    ("hacker_1", {
        ...
        "image": f"{settings.APP_HOST}/static/images/achievements/hack_1.png",
    ...
    ("photo_winner_2", {
        ...
        "image": f"{settings.APP_HOST}/static/images/achievements/photo_winner_2.png",
    ...
    ("photo_winner_3", {
        ...
        "image": f"{settings.APP_HOST}/static/images/achievements/photo_winner_3.png",
    ...
    ("vas3k_quest_2024", {
        ...
        "image": f"{settings.APP_HOST}/static/images/achievements/vas3k_quest_2024.png",
        "style": "background-color: #F1DFC5; font-size: 120%;",
    }),
    ("pokerface", {
        "name": "Покерфейс",
        "description": "Играл в покер с соклубниками",
        "image": f"{settings.APP_HOST}/static/images/achievements/pokerface.png",
